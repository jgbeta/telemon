...
pub const HARDWARE_STATE: &str = "hardware_state";
pub const HARDWARE_BATTERY_CHARGE_RATIO: &str = "hardware_battery_charge_ratio";
pub const HARDWARE_BATTERY_POWER_WATTS: &str = "hardware_battery_power_watts";
pub const HARDWARE_BATTERY_VOLTAGE_VOLTS: &str = "hardware_battery_voltage_volts";
pub const HARDWARE_BATTERY_CURRENT_AMPERES: &str = "hardware_battery_current_amperes";
...
pub const GAME_FPS_AVG: &str = "game_fps_avg";
pub const GAME_FPS_LOW_1PCT: &str = "game_fps_low_1pct";
pub const GAME_FPS_LOW_0_1PCT: &str = "game_fps_low_0_1pct";
pub const GAME_FRAME_TIME_AVG_MS: &str = "game_frame_time_avg_ms";
pub const GAME_FRAME_TIME_MIN_MS: &str = "game_frame_time_min_ms";
pub const GAME_FRAME_TIME_MAX_MS: &str = "game_frame_time_max_ms";
pub const GAME_FRAME_TIME_P50_MS: &str = "game_frame_time_p50_ms";
pub const GAME_FRAME_TIME_P95_MS: &str = "game_frame_time_p95_ms";
pub const GAME_FRAME_TIME_P99_MS: &str = "game_frame_time_p99_ms";
pub const GAME_FRAME_JITTER_AVG_MS: &str = "game_frame_jitter_avg_ms";
pub const GAME_FRAME_JITTER_P95_MS: &str = "game_frame_jitter_p95_ms";
pub const GAME_FRAME_JITTER_P99_MS: &str = "game_frame_jitter_p99_ms";
pub const GAME_FRAME_JITTER_MAX_MS: &str = "game_frame_jitter_max_ms";
